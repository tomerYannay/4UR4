...
| **R-10** | **The universe ruling trades one risk for another** | Self-computing the universe removes S&P index-licence exposure (a real saving) and replaces it with **4UR4 owning its own methodology risk**: eligibility rules, rebalance timing and point-in-time correctness become 4UR4's defect surface, not a vendor's. `universe-methodology.md` §6 and §12 accept this explicitly and name the divergences and gaps; the risk is *managed*, not removed, and its magnitude (G-U5, G-U6) is unquantified |
