...
> and must not be read as one; the Product Owner may overturn it at any time without
> cause.
>
...
>
> **The four scope limits, which travel with every use of this decision:**
...
>    Phase 3's.
> 2. **The stop index must be engine-derived**, never supplied by the fixture or the
>    harness; otherwise the clause asserts nothing about the engine's own detection.
> 3. **Half B *narrows* RM-01's Phase-2 assertable surface** to bars 0–9 plus the stop
...
> 4. **Circularity.** If the Half B expectation is generated by `tools/fixture-replay.mjs`
...
>    provenance.
>
> **No [GOV-015](../../../../governance/build-freeze.md) clearance is granted by any of
> this.** The build-freeze remains **ON**.
>
